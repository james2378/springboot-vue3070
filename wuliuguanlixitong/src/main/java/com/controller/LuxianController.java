    ...
    */
    ...
    public R save(@RequestBody LuxianEntity luxian, HttpServletRequest request){
        ...
        Wrapper<LuxianEntity> queryWrapper = new EntityWrapper<LuxianEntity>()
            ...
            .eq("yuangong_address", luxian.getYuangongAddress())
            .eq("yuangong_oadd", luxian.getYuangongOadd())
...
//                            luxianEntity.setLuxianName(data.get(0));                    //路线信息 要改的
//                            luxianEntity.setLuxianPhoto("");//详情和图片
//                            luxianEntity.setYuangongAddress(data.get(0));                    //始发地 要改的
//                            luxianEntity.setYuangongOadd(data.get(0));                    //目的地 要改的
...
//                            luxianEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //路线编号
                        List<LuxianEntity> luxianEntities_luxianUuidNumber = luxianService.selectList(new EntityWrapper<LuxianEntity>().in("luxian_uuid_number", seachFields.get("luxianUuidNumber")));
