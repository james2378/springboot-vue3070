        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='luxian'">
                    <el-form-item class="select" v-if="type!='info'"  label="物流路线" prop="luxianId">
                        <el-select v-model="ruleForm.luxianId" :disabled="ro.luxianId" filterable placeholder="请选择物流路线" @change="luxianChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='luxian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="路线编号" prop="luxianUuidNumber">
                        <el-input v-model="luxianForm.luxianUuidNumber"
                                  placeholder="路线编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='luxian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="路线信息" prop="luxianName">
                        <el-input v-model="luxianForm.luxianName"
                                  placeholder="路线信息" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='luxian' ">
